        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-gray-600 mb-6">
              Have questions about our education loans? Our team is ready to assist you every step of the way.
            </p>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#45267F] mb-4">Quick Inquiry</h2>
